 ...
 * repository. When it is absent the release build falls back to the debug key so the
 * project still builds for anyone who clones it; such a build is fine for testing and
